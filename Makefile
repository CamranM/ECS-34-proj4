...
all: directories run_strtest run_strsrctest run_strsinktest run_filesstest run_geoutilstest run_dsvtest run_xmltest run_csvbstest run_csvbsindextest run_dprtest run_osmtest   gencoverage
